...
public class SnakerGame {
    ...
    private static final String TAG = "SnakerGame";
    ...
    public SnakerGame(Context context) {
        this.context = context;
    }

    public SnakerGame setActiveBoxTask(Runnable task) {
        activeBoxTask = task;
        return this;
    }

    public SnakerGame start() {
        startActiveBox();
        return this;
    }

    public SnakerGame stop() {
    ...
    public SnakerGame startActiveBox() {
    ...
    public SnakerGame setScore(int score) {
        this.score = score;
        return this;
    }

    public SnakerGame setInterval(long interval) {
        if (interval > 0) {
